...
<head>
    <title>Heoo School System - Administrator Login</title>
    <meta charset="utf-8">
                ...
                <div class="col-md-7 col-lg-5">
                    <div class="login-wrap p-4 p-md-5">
                        <div class="login-header">
                            ...
                            <div class="w-100">
                                <h3 class="login-title mb-4" style="font-weight: 700;">Administrator Login</h3>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="login-form">
                            ...
                            <div class="form-group">
                                ...
                                <input id="Administrator_id" type="text" class="form-control rounded-left" name="email"
                                    :value="old('email')" placeholder="Administrator Email" required autofocus
