...
@section('title')
    {{ trans('invoices_trans.edit_invoice') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0" style="font-family: 'Cairo', sans-serif;"> {{ trans('invoices_trans.edit_invoice') }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                <li class="breadcrumb-item active"> {{ trans('invoices_trans.edit_invoice') }} </li>
            </ol>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        $('#amount_input').val('{{ $invoice->amount }}');
