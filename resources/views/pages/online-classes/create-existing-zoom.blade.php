    ...
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0" style="font-family: 'Cairo', sans-serif;">
                {{ trans('online_classes_trans.add_existing_meeting') }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                <li class="breadcrumb-item active"> {{ trans('online_classes_trans.add_existing_meeting') }} </li>
            </ol>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('online-classes.store-existing-zoom') }}" method="POST"
                            autocomplete="off">
                            @csrf
                            ...
                            <fieldset class="mb-3">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="meeting_id">{{ trans('online_classes_trans.meeting_id') }}</label>
                                    ...
                                    <div class="col">
                                        <label for="password">{{ trans('online_classes_trans.password') }}</label>
...
<hr>
                            <!-- Zoom Links -->
                            <fieldset class="mb-3">
                                <legend>{{ trans('online_classes_trans.links') }}</legend>
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="start_url">{{ trans('online_classes_trans.start_url') }}</label>
                                        <input type="url" name="start_url" class="form-control">
                                        @error('start_url')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col">
                                        <label for="join_url">{{ trans('online_classes_trans.join_url') }}</label>
