...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0" style="font-family: 'Cairo', sans-serif;"> {{ trans('receipts_trans.edit_receipt') }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                <li class="breadcrumb-item active"> {{ trans('receipts_trans.edit_receipt') }} </li>
            </ol>
        </div>
    </div>
</div>
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('receipts.update', $receipt->id) }}" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col">
                                    ...
                                    <input readonly class="form-control form-control-lg" type="text"
                                        value="{{ $receipt->students->name .' '.$receipt->students->parents->father_name}}" />
                                ...
                                <div class="form-group col">
                                    <label>{{ trans('receipts_trans.amount') }}</label>
                                    <input type="number" value="{{$receipt->debit}}" class="form-control form-control-lg" name="amount">
                                    @error('amount')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group ">
                                <label for="exampleFormControlTextarea1">{{ trans('receipts_trans.description') }}</label>
...
{{-- <script>
    $(document).ready(function() {
        ...
        $('#amount_input').val('{{ $receipt->amount }}');
