...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0" style="font-family: 'Cairo', sans-serif;"> {{ trans('refunds_trans.refunds') }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                <li class="breadcrumb-item active"> {{ trans('refunds_trans.refunds') }} </li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <a class="btn btn-success btn-sm btn-lg pull-right" href="{{ route('refunds.create') }}">
                    ...
                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                        ...
                        <thead>
                            <tr class="table-success">
                                ...
                                <th>{{ trans('refunds_trans.amount') }}</th>
                                <th>{{ trans('refunds_trans.reason') }}</th>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">
                                                {{ trans('refunds_trans.delete_refund') }}
                                            </h5>
                                            <button type="button"
                                                class="close"
                                                data-dismiss="modal"
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('refunds.destroy', $refund->id ) }}" method="post">
                                                {{ method_field('Delete') }}
                                                @csrf
                                                {{ trans('refunds_trans.deleteQ') }}
                                                <br>
                                                <input id="id" type="hidden" name="id" class="form-control" value="{{ $refund->id }}">
