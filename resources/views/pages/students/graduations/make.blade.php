...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6" >
            <h4 class="mb-0" style="font-family: 'Cairo', sans-serif;" > {{trans('students_trans.add_graduation')}}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                <li class="breadcrumb-item active"> {{trans('students_trans.add_graduation')}} </li>
            </ol>
        </div>
    </div>
</div>
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <div class="form-row  mb-2">
                            <h4 class="text-primary" style="font-family: 'Cairo', sans-serif;">{{trans('students_trans.add_graduation')}}</h4>
                        </div>
                        <div class="form-group ">
                            <div class="form-row">
                                ...
                                <input type="hidden" name="graduation_type" value="1">
