...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0" style="font-family: 'Cairo', sans-serif;"> {{ trans('subjects_trans.add_subject') }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                <li class="breadcrumb-item active"> {{ trans('subjects_trans.add_subject') }} </li>
            </ol>
        </div>
    </div>
</div>
                                    ...
                                    <select name="teacher_id" class="custom-select my-1 mr-sm-2">
                                        ...
                                        @foreach ($specializations as $specialization)
                                            <optgroup label="{{ $specialization->name }}">
                                                @foreach ($specialization->teachers as $teacher)
